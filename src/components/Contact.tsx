      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          <div className="text-center">
            ...
            <a
              className="w-16 h-16 mx-auto mb-4 bg-blue-100 dark:bg-blue-900 rounded-full flex items-center justify-center"
              href="mailto:shaquillenewell@gmail.com"
              target="_blank"
            ...
            {/* </a> */}
            <h3 className="text-lg font-semibold text-heading mb-2">Email</h3>
            <a
              href="mailto:shaquillenewell@gmail.com"
              className="text-accent hover:text-blue-700"
            >
              shaquillenewell@gmail.com
            </a>
          </div>
          <div className="text-center">
            <a
              className="w-16 h-16 mx-auto mb-4 bg-blue-100 dark:bg-blue-900 rounded-full flex items-center justify-center"
              href="https://www.linkedin.com/in/shaquille-newell-68880b142/"
              target="_blank"
              rel="noopener noreferrer"
            >
            ...
            <a
              ...
              className="text-accent hover:text-blue-700"
            >
              linkedin.com/in/shaquille-newell-68880b142/
            </a>
          </div>
          <div className="text-center">
            <a
              className="w-16 h-16 mx-auto mb-4 bg-blue-100 dark:bg-blue-900 rounded-full flex items-center justify-center"
              href="https://github.com/ShaqNew"
              target="_blank"
              rel="noopener noreferrer"
            >
              <i className="fa-brands fa-github text-2xl"></i>
            </a>
            <h3 className="text-lg font-semibold text-heading mb-2">GitHub</h3>
            <a
              href="https://github.com/ShaqNew"
              target="_blank"
              rel="noopener noreferrer"
        ...
        {/* <div className="flex justify-center space-x-6">
          ...
          <a
            href="https://twitter.com/shaqnewell"
            target="_blank"
            rel="noopener noreferrer"
            className="text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white"
          >
